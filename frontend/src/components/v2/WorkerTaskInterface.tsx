        ...
        <div className="flex flex-col h-screen overflow-hidden bg-gray-950 text-gray-200 font-sans">
            ...
            <main className="flex-1 flex overflow-hidden">
                ...
                <aside className="w-80 bg-gray-900 border-l border-gray-800 flex flex-col z-10">
                    <div className="bg-gray-850 p-5 border-b border-gray-800 text-xs text-gray-400 shrink-0">
                        <p className="mb-2 font-bold text-gray-500 uppercase flex items-center gap-2">
                            <Info className="w-3.5 h-3.5" /> Instructions
                        </p>
                        <p className="text-gray-200 text-sm leading-relaxed">{config.instruction}</p>
                    </div>
